...
class GdalConstPINVOKE {
  ...
  [DllImport("gdalconst_wrap", EntryPoint="CSharp_OF_MULTIDIM_RASTER_get")]
  ...
  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DCAP_UNIQUE_FIELDS_get")]
  public static extern string DCAP_UNIQUE_FIELDS_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DIM_TYPE_HORIZONTAL_X_get")]
  public static extern string DIM_TYPE_HORIZONTAL_X_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DIM_TYPE_HORIZONTAL_Y_get")]
  public static extern string DIM_TYPE_HORIZONTAL_Y_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DIM_TYPE_VERTICAL_get")]
  public static extern string DIM_TYPE_VERTICAL_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DIM_TYPE_TEMPORAL_get")]
  public static extern string DIM_TYPE_TEMPORAL_get();

  [DllImport("gdalconst_wrap", EntryPoint="CSharp_DIM_TYPE_PARAMETRIC_get")]
