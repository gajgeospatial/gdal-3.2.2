...
SWIGEXPORT int SWIGSTDCALL CSharp_OF_MULTIDIM_RASTER_get() {
  int jresult ;
  int result;
  
  result = (int) GDAL_OF_MULTIDIM_RASTER;
  jresult = result; 
  return jresult;
}
...
SWIGEXPORT char * SWIGSTDCALL CSharp_DCAP_NOTNULL_FIELDS_get() {
  ...
  result = (char *) "DCAP_NOTNULL_FIELDS";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}
...
SWIGEXPORT char * SWIGSTDCALL CSharp_DCAP_DEFAULT_FIELDS_get() {
  ...
  result = (char *) "DCAP_DEFAULT_FIELDS";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}
...
SWIGEXPORT char * SWIGSTDCALL CSharp_DCAP_NOTNULL_GEOMFIELDS_get() {
  ...
  result = (char *) "DCAP_NOTNULL_GEOMFIELDS";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DCAP_UNIQUE_FIELDS_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "DCAP_UNIQUE_FIELDS";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DIM_TYPE_HORIZONTAL_X_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "HORIZONTAL_X";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DIM_TYPE_HORIZONTAL_Y_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "HORIZONTAL_Y";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DIM_TYPE_VERTICAL_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "VERTICAL";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DIM_TYPE_TEMPORAL_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "TEMPORAL";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}


SWIGEXPORT char * SWIGSTDCALL CSharp_DIM_TYPE_PARAMETRIC_get() {
  char * jresult ;
  char *result = 0 ;
  
  result = (char *) "PARAMETRIC";
  jresult = SWIG_csharp_string_callback((const char *)result); 
  return jresult;
}
