...
public class MDArray : IDisposable {
  ...
  public CPLErr SetOffset(double val) {
    CPLErr ret = (CPLErr)GdalPINVOKE.MDArray_SetOffset(swigCPtr, val);
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public CPLErr SetScale(double val) {
    CPLErr ret = (CPLErr)GdalPINVOKE.MDArray_SetScale(swigCPtr, val);
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
