...
class OgrPINVOKE {
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_DataSource_AbortSQL")]
  public static extern int DataSource_AbortSQL(HandleRef jarg1);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_FieldDefn_GetAlternativeName")]
  public static extern string FieldDefn_GetAlternativeName(HandleRef jarg1);

  [DllImport("ogr_wrap", EntryPoint="CSharp_FieldDefn_GetAlternativeNameRef")]
  public static extern string FieldDefn_GetAlternativeNameRef(HandleRef jarg1);

  [DllImport("ogr_wrap", EntryPoint="CSharp_FieldDefn_SetAlternativeName")]
  public static extern void FieldDefn_SetAlternativeName(HandleRef jarg1, string jarg2);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_FieldDefn_IsUnique")]
  public static extern int FieldDefn_IsUnique(HandleRef jarg1);

  [DllImport("ogr_wrap", EntryPoint="CSharp_FieldDefn_SetUnique")]
  public static extern void FieldDefn_SetUnique(HandleRef jarg1, int jarg2);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_CreateGeometryFromEsriJson")]
  public static extern IntPtr CreateGeometryFromEsriJson(string jarg1);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_Geometry_MakeValid")]
  public static extern IntPtr Geometry_MakeValid(HandleRef jarg1);

  [DllImport("ogr_wrap", EntryPoint="CSharp_Geometry_RemoveLowerDimensionSubGeoms")]
  public static extern IntPtr Geometry_RemoveLowerDimensionSubGeoms(HandleRef jarg1);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_Geometry_Transform__SWIG_0")]
  public static extern int Geometry_Transform__SWIG_0(HandleRef jarg1, HandleRef jarg2);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_Geometry_Transform__SWIG_1")]
  public static extern IntPtr Geometry_Transform__SWIG_1(HandleRef jarg1, HandleRef jarg2);
  ...
  [DllImport("ogr_wrap", EntryPoint="CSharp_new_GeomTransformer")]
  public static extern IntPtr new_GeomTransformer(HandleRef jarg1, IntPtr[] jarg2);

  [DllImport("ogr_wrap", EntryPoint="CSharp_delete_GeomTransformer")]
  public static extern void delete_GeomTransformer(HandleRef jarg1);

  [DllImport("ogr_wrap", EntryPoint="CSharp_GeomTransformer_Transform")]
  public static extern IntPtr GeomTransformer_Transform(HandleRef jarg1, HandleRef jarg2);
