...
class OsrPINVOKE {
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfoList_get")]
  public static extern IntPtr CRSInfoList_get(HandleRef jarg1, int jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_delete_CRSInfoList")]
  public static extern void delete_CRSInfoList(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_CRSInfoList")]
  public static extern IntPtr new_CRSInfoList();

  [DllImport("osr_wrap", EntryPoint="CSharp_GetCRSInfoListFromDatabase")]
  public static extern IntPtr GetCRSInfoListFromDatabase(string jarg1, out int jarg2);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_AreaOfUse_west_lon_degree_get")]
  public static extern double AreaOfUse_west_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_AreaOfUse_south_lat_degree_get")]
  public static extern double AreaOfUse_south_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_AreaOfUse_east_lon_degree_get")]
  public static extern double AreaOfUse_east_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_AreaOfUse_north_lat_degree_get")]
  public static extern double AreaOfUse_north_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_AreaOfUse_name_get")]
  public static extern string AreaOfUse_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_AreaOfUse")]
  public static extern IntPtr new_AreaOfUse(double jarg1, double jarg2, double jarg3, double jarg4, string jarg5);

  [DllImport("osr_wrap", EntryPoint="CSharp_delete_AreaOfUse")]
  public static extern void delete_AreaOfUse(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRAreaOfUse_west_lon_degree_get")]
  public static extern double OSRAreaOfUse_west_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRAreaOfUse_south_lat_degree_get")]
  public static extern double OSRAreaOfUse_south_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRAreaOfUse_east_lon_degree_get")]
  public static extern double OSRAreaOfUse_east_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRAreaOfUse_north_lat_degree_get")]
  public static extern double OSRAreaOfUse_north_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRAreaOfUse_name_get")]
  public static extern string OSRAreaOfUse_name_get(HandleRef jarg1);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_GetName")]
  public static extern string SpatialReference_GetName(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_IsSame")]
  public static extern int SpatialReference_IsSame(HandleRef jarg1, HandleRef jarg2, IntPtr[] jarg3);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_IsDerivedGeographic")]
  public static extern int SpatialReference_IsDerivedGeographic(HandleRef jarg1);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_GetAreaOfUse")]
  public static extern IntPtr SpatialReference_GetAreaOfUse(HandleRef jarg1);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_GetAxesCount")]
  public static extern int SpatialReference_GetAxesCount(HandleRef jarg1);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_GetAxisMappingStrategy")]
  public static extern int SpatialReference_GetAxisMappingStrategy(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_SetAxisMappingStrategy")]
  public static extern void SpatialReference_SetAxisMappingStrategy(HandleRef jarg1, int jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_GetDataAxisToSRSAxisMapping")]
  public static extern IntPtr SpatialReference_GetDataAxisToSRSAxisMapping(HandleRef jarg1, out int jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_SetDataAxisToSRSAxisMapping")]
  public static extern int SpatialReference_SetDataAxisToSRSAxisMapping(HandleRef jarg1, int jarg2, int[] jarg3);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_SetVerticalPerspective")]
  public static extern int SpatialReference_SetVerticalPerspective(HandleRef jarg1, double jarg2, double jarg3, double jarg4, double jarg5, double jarg6, double jarg7);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_HasTOWGS84")]
  public static extern bool SpatialReference_HasTOWGS84(HandleRef jarg1);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_AddGuessedTOWGS84")]
  public static extern int SpatialReference_AddGuessedTOWGS84(HandleRef jarg1);
  ...
  public static extern int SpatialReference_ExportToWkt(HandleRef jarg1, out string jarg2, IntPtr[] jarg3);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_ExportToPROJJSON")]
  public static extern int SpatialReference_ExportToPROJJSON(HandleRef jarg1, out string jarg2, IntPtr[] jarg3);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_PromoteTo3D")]
  public static extern int SpatialReference_PromoteTo3D(HandleRef jarg1, string jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_SpatialReference_DemoteTo2D")]
  public static extern int SpatialReference_DemoteTo2D(HandleRef jarg1, string jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_CoordinateTransformationOptions")]
  public static extern IntPtr new_CoordinateTransformationOptions();

  [DllImport("osr_wrap", EntryPoint="CSharp_delete_CoordinateTransformationOptions")]
  public static extern void delete_CoordinateTransformationOptions(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CoordinateTransformationOptions_SetAreaOfInterest")]
  public static extern bool CoordinateTransformationOptions_SetAreaOfInterest(HandleRef jarg1, double jarg2, double jarg3, double jarg4, double jarg5);

  [DllImport("osr_wrap", EntryPoint="CSharp_CoordinateTransformationOptions_SetOperation")]
  public static extern bool CoordinateTransformationOptions_SetOperation(HandleRef jarg1, string jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_CoordinateTransformation__SWIG_0")]
  public static extern IntPtr new_CoordinateTransformation__SWIG_0(HandleRef jarg1, HandleRef jarg2);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_CoordinateTransformation__SWIG_1")]
  public static extern IntPtr new_CoordinateTransformation__SWIG_1(HandleRef jarg1, HandleRef jarg2, HandleRef jarg3);
  ...
  [DllImport("osr_wrap", EntryPoint="CSharp_CoordinateTransformation_TransformPoint__SWIG_2")]
  public static extern void CoordinateTransformation_TransformPoint__SWIG_2(HandleRef jarg1, double[] jarg2, double jarg3, double jarg4, double jarg5);

  [DllImport("osr_wrap", EntryPoint="CSharp_CoordinateTransformation_TransformPoint__SWIG_3")]
  public static extern void CoordinateTransformation_TransformPoint__SWIG_3(HandleRef jarg1, double[] jarg2, double jarg3, double jarg4, double jarg5, double jarg6);
  ...
  public static extern IntPtr CreateCoordinateTransformation(HandleRef jarg1, HandleRef jarg2, HandleRef jarg3);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_auth_name_get")]
  public static extern string CRSInfo_auth_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_code_get")]
  public static extern string CRSInfo_code_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_name_get")]
  public static extern string CRSInfo_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_type_get")]
  public static extern int CRSInfo_type_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_deprecated_get")]
  public static extern bool CRSInfo_deprecated_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_bbox_valid_get")]
  public static extern bool CRSInfo_bbox_valid_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_west_lon_degree_get")]
  public static extern double CRSInfo_west_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_south_lat_degree_get")]
  public static extern double CRSInfo_south_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_east_lon_degree_get")]
  public static extern double CRSInfo_east_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_north_lat_degree_get")]
  public static extern double CRSInfo_north_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_area_name_get")]
  public static extern string CRSInfo_area_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_CRSInfo_projection_method_get")]
  public static extern string CRSInfo_projection_method_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_new_CRSInfo")]
  public static extern IntPtr new_CRSInfo(string jarg1, string jarg2, string jarg3, int jarg4, bool jarg5, bool jarg6, double jarg7, double jarg8, double jarg9, double jarg10, string jarg11, string jarg12);

  [DllImport("osr_wrap", EntryPoint="CSharp_delete_CRSInfo")]
  public static extern void delete_CRSInfo(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_auth_name_get")]
  public static extern string OSRCRSInfo_auth_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_code_get")]
  public static extern string OSRCRSInfo_code_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_name_get")]
  public static extern string OSRCRSInfo_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_type_get")]
  public static extern int OSRCRSInfo_type_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_deprecated_get")]
  public static extern bool OSRCRSInfo_deprecated_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_bbox_valid_get")]
  public static extern bool OSRCRSInfo_bbox_valid_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_west_lon_degree_get")]
  public static extern double OSRCRSInfo_west_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_south_lat_degree_get")]
  public static extern double OSRCRSInfo_south_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_east_lon_degree_get")]
  public static extern double OSRCRSInfo_east_lon_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_north_lat_degree_get")]
  public static extern double OSRCRSInfo_north_lat_degree_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_area_name_get")]
  public static extern string OSRCRSInfo_area_name_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_OSRCRSInfo_projection_method_get")]
  public static extern string OSRCRSInfo_projection_method_get(HandleRef jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_SetPROJSearchPath")]
  public static extern void SetPROJSearchPath(byte[] jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_SetPROJSearchPaths")]
  public static extern void SetPROJSearchPaths(IntPtr[] jarg1);

  [DllImport("osr_wrap", EntryPoint="CSharp_GetPROJSearchPaths")]
  public static extern IntPtr GetPROJSearchPaths();

  [DllImport("osr_wrap", EntryPoint="CSharp_GetPROJVersionMajor")]
  public static extern int GetPROJVersionMajor();

  [DllImport("osr_wrap", EntryPoint="CSharp_GetPROJVersionMinor")]
  public static extern int GetPROJVersionMinor();

  [DllImport("osr_wrap", EntryPoint="CSharp_GetPROJVersionMicro")]
